...
import type { TenancyOrganizationListResponse } from "@afenda/tenancy/zod";

interface OrganizationsPageClientProps {
  /** Server-fetched initial data to avoid client-side waterfall */
  initialData?: TenancyOrganizationListResponse | null;
}

export function OrganizationsPageClient({ initialData }: OrganizationsPageClientProps) {
  const [search, setSearch] = useState("");

  const { data, isLoading, error } = useOrganizationsQuery(undefined, {
