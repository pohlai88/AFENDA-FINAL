...
export default function InvitationError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
      console.error("[Tenancy/Invitation] Error boundary:", error);
    }
  }, [error]);
      ...
      <Card className="max-w-md w-full">
        ...
        <CardContent className="space-y-4 pt-6">
          <Alert variant="destructive">
            ...
            <AlertDescription>
              {error.message || "This invitation link may be invalid or expired. Please contact the organization admin."}
            </AlertDescription>
          </Alert>
          {error.digest && (
