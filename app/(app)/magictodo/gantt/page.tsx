 ...
 * Gantt chart view with timeline visualization, drag-to-resize, dependency arrows,
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: count > 2 
                        ? `rgba(239, 68, 68, ${intensity})` // Red for overload
                        : `rgba(59, 130, 246, ${intensity})`, // Blue for normal
                    }}
                    title={`${count} task(s)`}
                  />
                )
