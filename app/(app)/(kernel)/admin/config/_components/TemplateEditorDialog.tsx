 ...
 * Create new or edit existing configuration templates
 */
...
const templateEditorSchema = z.object({
  ...
  configs: z.array(
    z.object({
      ...
      required: z.boolean(),
      validationType: z.enum(["string", "number", "boolean", "email", "url", "array", "enum", "json"]),
    })
...
export function TemplateEditorDialog({
  ...
  const form = useForm<TemplateEditorFormData, unknown, TemplateEditorFormData>({
    ...
    defaultValues: template
      ? {
        ...
        configs: template.configs.map((c) => ({
          ...
          required: c.required,
          validationType: c.validation.type as "string" | "number" | "boolean" | "email" | "url" | "array" | "enum" | "json",
        })),
      }
      : {
        id: "",
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {mode === "edit" && !template?.id.startsWith("custom-") && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  System templates are immutable. Use &quot;Save as New&quot; to create a customized version.
                </AlertDescription>
              </Alert>
            )}
