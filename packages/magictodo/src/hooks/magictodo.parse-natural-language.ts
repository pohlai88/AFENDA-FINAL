 ...
 * Extracts due date keywords, priority words, and #tags from free-text input.
 *
 * @domain magictodo
 * @layer hooks
 */
 ...
 * @example
 * ```ts
 * const result = parseNaturalLanguage("Buy groceries tomorrow #shopping high");
 * // { title: "Buy groceries", dueDate: "2026-02-10", priority: "high", tags: ["shopping"] }
 * ```
 */
